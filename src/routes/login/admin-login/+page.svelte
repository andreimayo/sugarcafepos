        ...
        async function login(event) {
            ...
            try {
                const response = await fetch(apiUrl, {
                    ...
                    body: JSON.stringify({
                        action: 'login',
                        username: 'admin', // Assuming a fixed admin username
                        password: password,
                        role: 'admin'
                    }),
                });
                ...
                if (data.success) {
                    ...
                    // Redirect to admin dashboard (you'll need to implement this navigation)
                    console.log('Admin login successful. Redirect to admin dashboard.');
                } else {
